...
columns = (['duration'
    ...
    , 'attack'
    , 'level'])
df_train = pd.read_csv(r"C:/Users/admin/Sanket/project1/10th/archive (1)/KDDTrain+.txt", header=None, names=columns)
df_test = pd.read_csv(r"C:/Users/admin/Sanket/project1/10th/archive (1)/KDDTest+.txt", header=None, names=columns)
