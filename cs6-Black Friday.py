...
test=pd.read_csv("C:/Users/admin/Sanket/project1/Black Friday Sales/test.csv")
train=pd.read_csv("C:/Users/admin/Sanket/project1/Black Friday Sales/train.csv")
